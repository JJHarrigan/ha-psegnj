# PSEG New Jersey Integration Installation Guide

This guide will walk you through installing and configuring the PSEG New Jersey integration for Home Assistant.

## Prerequisites

- Home Assistant (Core, OS, or Supervised)
- PSEG New Jersey account with Smart Energy enabled
...
3. **Install Integration**
   ...
   - Find "PSEG New Jersey" in the HACS Integrations list
   - Click **Download**
...
4. **Configure Integration**
   ...
   - Search for "PSEG New Jersey" and select it
...
2. **Manual Update**: Update the cookie via **Settings** > **Devices & Services** > **PSEG New Jersey** > **Configure**
...
The PSEG New Jersey Automation Addon provides automatic cookie refresh capabilities:
...
1. **Install Addon**
   ...
   - Add the PSEG New Jersey Automation repository
   - Install the addon
...
1. **Integration Status**
   ...
   - Go to **Settings** > **Devices & Services** > **PSEG New Jersey**
